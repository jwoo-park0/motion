...
import sys
sys.path.append('/nfs/home/wldn1677/aaai2026/VideoCrafter')
...
def get_parser():
    ...
    parser.add_argument('--lib', choices=['func', 'func_own','func_freq'], default='func')
    return parser
...
def run_inference(args, gpu_num, gpu_no, **kwargs):
    ...
    kwargs.update({'attn_processor_config': config.attn_processor_config})
    ...
    model.config.guidance_steps = 50
