...
from query_util import QueryStore, query_unet_attention
...
def get_parser():
    ...
    parser.add_argument('--lib', choices=['func', 'func_own'], default='func_own')
    return parser
...
if __name__ == '__main__':
    ...
    if args.lib == 'func_own':
        from funcs_own import load_model_checkpoint, load_prompts, load_image_batch, get_filelist, save_videos
        from funcs_own import batch_ddim_sampling
    else:
