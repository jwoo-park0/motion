...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
        ...
        total_steps = timesteps if ddim_use_original_steps else timesteps.shape[0] ; verbose = True
        if verbose:
        ...
        for i, step in enumerate(iterator):
            ...
            self.model.model.diffusion_model = prep_unet_attention(self.model.model.diffusion_model, mode='inject', **kwargs)
